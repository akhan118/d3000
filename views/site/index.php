...
$this->title = 'Dictionary3000 - Visual English Dictionary';
?>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-6">
                        ...
                        <div class="col-xs-12 col-sm-11 col-md-6 clickable">
                            <h2 class="h2_border">
                                ...
                                echo Html::a(str_replace("'", "", $word_of_the_day->word), ['/dictionary/index/', 'word' => str_replace("'", "", $word_of_the_day->word)]);
                                ?>
                            </h2>
                        </div>  
                            ...
                            <div class="col-xs-12 col-sm-12 clickable ">
                              ...
                              <?php     
                                    for ($i = 0; $i < count($definitions); $i++) {
                                        ...
                                        echo '<p class="lead">'.$definitions[$i]->text.'</p>';
...
//                        }
                        ...
                        <span class="clickable">
                               ...
                               /// var_dump($examples);
                                for ($i = 0; $i < count($examples); $i++) {
                                        ...
                                        echo '<p class="lead">'.$examples[$i]->text .'</p>';
                    ...
                    <div class="col-xs-12 col-sm-10 col-md-8 ">
                        ...
                        <span class="clickable">
                                <?php
                                        ...
                                        echo '<p class="lead">'.$word_of_the_day->note.'</p>';
            ...
            <a  href="http://www.wordnik.com/words/<?php echo $word_of_the_day->word ?>"> <img src="wordnik_badge_a2.png"  alt="Power by Wordnik" > </a>

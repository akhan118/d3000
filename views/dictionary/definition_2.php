...
<script>
    $(document).ready(function() {
        ...
        p.dblclick(function(e) {
            ...
            if (word !== '') {
                window.location = ' http://dictionary3000.com/dictionary/index?Dictionary%5Binput%5D=' + word + '&search_button=';
            }
            range.collapse();
            e.stopPropagation();
        });
    ...
    <div class="row">  
        ...
        <div class="col-sm-offset-4 col-md-offset-4 col-lg-offset-4 col-sm-5 col-md-4 col-lg-5 form-inline">
            ...
            $form = ActiveForm::begin([
                        ...
                        'method' => 'get',
                        'action' => ['dictionary/index'],
            ]);
            ;

            // echo     // $form->field(new app\models\Dictionary(), 'id') ;
            echo $form->field(new app\models\Dictionary(), 'input')->textInput(array('class' => 'form-control'));
        ...
        <div class="col-xs-12 col-md-8">
            ...
            ?>   
                      ...
                      <div class=" col-xs-1 col-md-1">
                        <?php
                        if (is_array($audio)) {
                            echo '<button id="audio_b" type="button" >

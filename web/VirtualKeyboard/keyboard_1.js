...
window.keyboard_host = "http://dictionary3000.com/VirtualKeyboard/keyboard.png";

var VKI_attach, VKI_close;
(function() {
  var self = this;

  this.VKI_version = "false";
  ...
  this.VKI_imageURI = window.keyboard_host;// "/keyboard.png";  // If empty string, use imageless mode
